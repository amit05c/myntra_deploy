import { Box, Flex, Grid, Input, Spacer } from "@chakra-ui/react";
...
const FooterPart = () => {
  return (
    <div  style={{ backgroundColor: "#f7f6f2", border: "2px solid #e7e4e0" , marginTop:"1rem"}}>
      <Box
